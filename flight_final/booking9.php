...
<tr>
<td>Time:</td>
<td><input type="text" name="dip" value="Dispatcher 10:30AM" /></td>
...
<select id="x1x" name="x1x" required="required">
	<option value="">-----------</option>
	<option value="10000">First Class</option>
	<option value="7500">Second Class</option>
	<option value="5000">Third Class</option>
</select>
</td>
