...
<br />
<form method="post">
Booking Cancellation: <input type="text" placeholder="Cancled" name="cal" class="cal" required="required">
...
<textarea placeholder="Request For Ticket Booking Cancellation" cols="70" rows="15" pattern=".{10,}" title="Ten or more characters" type="text" required="required" id="txt1" name="txt1"></textarea>
<br />
